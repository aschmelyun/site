<x-layout title="Home" description="Software engineer with too many ideas and a passion for tinkering.">
    ...
    <div class="flex mt-0 lg:mt-8 px-4 md:px-0">
        <div class="relative z-10 w-full md:w-2/3 mt-4 lg:mt-16">
            <h1 class="text-3xl lg:text-4xl lg:leading-relaxed font-semibold leading-normal text-gray-900 pr-0 md:pr-6">
            ...
            <div class="flex items-center justify-start mt-8">
                ...
                <a class="block mr-8 md:mr-12 fill-current text-gray-900 hover:text-slate-500 transform hover:-translate-y-1 transition-all duration-200" href="https://twitter.com/aschmelyun" target="_blank" rel="noreferrer">
                ...
                <a class="block mr-8 md:mr-12 fill-current text-gray-900 hover:text-slate-500 transform hover:-translate-y-1 transition-all duration-200" href="https://youtube.com/aschmelyun" target="_blank" rel="noreferrer">
    ...
    <div class="mt-16 md:mt-24 px-4 md:px-0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 leading-relaxed">
